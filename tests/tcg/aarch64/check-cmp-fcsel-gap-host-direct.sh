...
log="${exe}.cmp_fcsel_gap.log"
nm_log="${exe}.cmp_fcsel_gap.nm"
rm -f "$log" "$nm_log"
...
assert_positive "cmp fcsel eq gap1" \
    cmp_fcsel_eq_gap1_producer cmp_fcsel_eq_gap1_consumer 2
assert_positive "cmp fcsel lt gap4" \
    cmp_fcsel_lt_gap4_producer cmp_fcsel_lt_gap4_consumer 5
assert_positive "cmp fcsel hi gap8" \
    cmp_fcsel_hi_gap8_producer cmp_fcsel_hi_gap8_consumer 9

assert_no_use "cmp fcsel bad gap" cmp_fcsel_bad_gap_producer
