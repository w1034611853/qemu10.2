...
log="${exe}.subs_rd_ccmp_gap.log"
nm_log="${exe}.subs_rd_ccmp_gap.nm"
rm -f "$log" "$nm_log"
...
assert_positive "subs rd ccmp true gap1" \
    subs_rd_ccmp_true_gap1_producer subs_rd_ccmp_true_gap1_consumer 2
assert_positive "subs rd ccmp false gap4" \
    subs_rd_ccmp_false_gap4_producer subs_rd_ccmp_false_gap4_consumer 5
assert_positive "subs rd ccmn true gap8" \
    subs_rd_ccmn_true_gap8_producer subs_rd_ccmn_true_gap8_consumer 9

assert_no_use "subs rd ccmp bad gap" subs_rd_ccmp_bad_gap_producer
