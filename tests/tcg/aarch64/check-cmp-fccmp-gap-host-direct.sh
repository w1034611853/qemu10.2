...
assert_positive "cmp fccmp true gap1" \
    cmp_fccmp_true_gap1_producer cmp_fccmp_true_gap1_consumer 2
assert_positive "cmp fccmp false gap4" \
    cmp_fccmp_false_gap4_producer cmp_fccmp_false_gap4_consumer 5
assert_positive "cmp fccmp true gap8" \
    cmp_fccmp_true_gap8_producer cmp_fccmp_true_gap8_consumer 9
