...
log="${exe}.cmp_ccmp_ccmp_chain.log"
nm_log="${exe}.cmp_ccmp_ccmp_chain.nm"
block_dir="${exe}.cmp_ccmp_ccmp_chain.blocks"
rm -f "$log" "$nm_log"
rm -rf "$block_dir"
mkdir -p "$block_dir"
...
assert_gap_fallback()
{
    ...
    assert_no_record "$label first ccmp producer" "$first_ccmp_sym"
    assert_case_contains "$label first ccmp block" "$first_ccmp_sym" 'mov_i32 x86_raw_flags'
...
assert_chain_positive \
    "cmp ccmp eq -> ccmp eq -> b.eq" \
    cmp_ccmp_eq_ccmp_eq_bcond_eq_chain_producer \
    cmp_ccmp_eq_ccmp_eq_bcond_eq_chain_first_ccmp \
    cmp_ccmp_eq_ccmp_eq_bcond_eq_chain_second_ccmp \
    cmp_ccmp_eq_ccmp_eq_bcond_eq_chain_branch

assert_chain_positive \
    "cmp ccmp false-lit lt -> ccmp lt -> b.eq" \
    cmp_ccmp_false_lit_lt_ccmp_lt_bcond_eq_chain_producer \
    cmp_ccmp_false_lit_lt_ccmp_lt_bcond_eq_chain_first_ccmp \
    cmp_ccmp_false_lit_lt_ccmp_lt_bcond_eq_chain_second_ccmp \
    cmp_ccmp_false_lit_lt_ccmp_lt_bcond_eq_chain_branch

assert_chain_positive \
    "cmp ccmn hi -> ccmn eq -> b.eq" \
    cmp_ccmn_hi_ccmn_eq_bcond_eq_chain_producer \
    cmp_ccmn_hi_ccmn_eq_bcond_eq_chain_first_ccmp \
    cmp_ccmn_hi_ccmn_eq_bcond_eq_chain_second_ccmp \
    cmp_ccmn_hi_ccmn_eq_bcond_eq_chain_branch

assert_gap_fallback \
    "cmp ccmp eq gap -> ccmp eq -> b.eq fallback" \
    cmp_ccmp_eq_ccmp_eq_gap_producer \
    cmp_ccmp_eq_ccmp_eq_gap_first_ccmp \
    cmp_ccmp_eq_ccmp_eq_gap_second_ccmp \
    cmp_ccmp_eq_ccmp_eq_gap_branch
