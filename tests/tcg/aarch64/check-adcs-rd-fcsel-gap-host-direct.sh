...
log="${exe}.adcs_rd_fcsel_gap.log"
nm_log="${exe}.adcs_rd_fcsel_gap.nm"
rm -f "$log" "$nm_log"
...
assert_record "adcs rd fcsel eq gap1" adcs_rd_fcsel_eq_gap1_producer
assert_peek "adcs rd fcsel eq gap1" \
    adcs_rd_fcsel_eq_gap1_producer adcs_rd_fcsel_eq_gap1_consumer 2

assert_record "adcs rd fcsel vs gap4" adcs_rd_fcsel_vs_gap4_producer
assert_peek "adcs rd fcsel vs gap4" \
    adcs_rd_fcsel_vs_gap4_producer adcs_rd_fcsel_vs_gap4_consumer 5

assert_no_use "adcs rd fcsel bad gap" adcs_rd_fcsel_bad_gap_producer
