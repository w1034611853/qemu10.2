...
log="${exe}.subs_rd_fcsel_gap.log"
nm_log="${exe}.subs_rd_fcsel_gap.nm"
rm -f "$log" "$nm_log"
...
assert_record "subs rd fcsel eq gap1" subs_rd_fcsel_eq_gap1_producer
assert_peek "subs rd fcsel eq gap1" \
    subs_rd_fcsel_eq_gap1_producer subs_rd_fcsel_eq_gap1_consumer 2

assert_record "subs rd fcsel lt gap4" subs_rd_fcsel_lt_gap4_producer
assert_peek "subs rd fcsel lt gap4" \
    subs_rd_fcsel_lt_gap4_producer subs_rd_fcsel_lt_gap4_consumer 5

assert_no_use "subs rd fcsel bad gap" subs_rd_fcsel_bad_gap_producer
