...
log="${exe}.adcs_rd_csel_gap.log"
nm_log="${exe}.adcs_rd_csel_gap.nm"
rm -f "$log" "$nm_log"
...
assert_record "adcs rd csel eq gap1" adcs_rd_csel_eq_gap1_producer
assert_peek "adcs rd csel eq gap1" \
    adcs_rd_csel_eq_gap1_producer adcs_rd_csel_eq_gap1_consumer 2

assert_record "adcs rd csel vs gap4" adcs_rd_csel_vs_gap4_producer
assert_peek "adcs rd csel vs gap4" \
    adcs_rd_csel_vs_gap4_producer adcs_rd_csel_vs_gap4_consumer 5

assert_no_use "adcs rd csel bad gap" adcs_rd_csel_bad_gap_producer
